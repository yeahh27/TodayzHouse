	...
	<c:choose>
		<c:when test="${not empty articleList}">
			...
			<div style="display: inline-block; width: 20%; margin-bottom: 15px; margin-left: 15px" >
				...
				<div>
					<span style="padding: 8%"><img src="/TodayzHouse/img/recommend2.png" width="7%" style="padding-right: 9px;">${article.recommend}</span>
					<span style="padding: 8%"><img src="/TodayzHouse/img/comment.png" width="9%" style="padding-right: 9px;">${fn:length(article.replyList)}</span>
					<span style="padding: 8%"><img src="/TodayzHouse/img/report.png" width="9%" style="padding-right: 9px;">${article.report}</span>
				</div>
